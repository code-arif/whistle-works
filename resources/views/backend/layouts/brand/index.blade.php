                                ...
                                <table class="table table-bordered text-nowrap border-bottom" id="datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="bg-transparent border-bottom-0 wp-15">Subcategory Name</th>
                                            <th class="bg-transparent border-bottom-0">Brand Name</th>
                                            <th class="bg-transparent border-bottom-0">Color Name</th>
                                            <th class="bg-transparent border-bottom-0">Color Code</th>
        ...
        if (!$.fn.DataTable.isDataTable('#datatable')) {
            let dTable = $('#datatable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'subcategoryBrand',
                        name: 'subcategoryBrand',
                        orderable: false,
                        searchable: false
                    },
                    {
                        data: 'subcategoryColor',
                    ...
                    {
                        data: 'subcategoryColorCode',
                        name: 'subcategoryColorCode',
                        orderable: false,
                        searchable: false
                    },
                    {
