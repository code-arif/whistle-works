            ...
            <div class="row">
                <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                    <div class="card box-shadow-0">
                        <div class="card-body">
                            <form class="form form-horizontal" method="post" action="{{ route('admin.cms.privecyandterms.terms.update') }}" enctype="multipart/form-data">
                                @csrf
                                @method('POST')
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <textarea class="form-control summernote @error('description') is-invalid @enderror"
                                            name="description" id="description" rows="5">{{ $terms->description ?? old('description') ?? '' }}</textarea>
                                        @error('description')
