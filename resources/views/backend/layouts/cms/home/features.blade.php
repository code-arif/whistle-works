                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xl-4 col-md-12 col-sm-12">
                        <div class="card box-shadow-0">
                            <div class="card-body">
                                <form class="form-horizontal" method="POST" action="{{ route('admin.cms.home.features.store') }}">
                                    @csrf
                                    <div class="row mb-4">
            ...
            <div class="modal-content">
                <form id="itemForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="itemModalLabel">Add Feature Image</h5>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#datatable')) {
                let dTable = $('#datatable').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.cms.home.features.index') }}",
                        type: "GET",
                    },
            ...
            $('#itemForm').on('submit', function(e) {
                ...
                var id = $('#itemID').val();
                var url = id ? "{{ route('admin.cms.home.features.item.update', ':id') }}".replace(':id', id) :
                    "{{ route('admin.cms.home.features.item.store') }}";
            ...
            $(document).on('click', '.editItem', function() {
                var id = $(this).data('id');
                var url = "{{ route('admin.cms.home.features.item.edit', ':id') }}".replace(':id', id);
        ...
        function deleteItem(id) {
            NProgress.start();
            let url = "{{ route('admin.cms.home.features.item.destroy', ':id') }}";
