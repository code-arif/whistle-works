                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tr>
                        <td style="padding: 8px 0; border-bottom: 1px solid #f0f0f0;">
                            ...
                            <strong style="color: #333333; font-size: 14px;">{{ $user->phone }}</strong>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; border-bottom: 1px solid #f0f0f0;">
                            ...
                            <strong
                                style="color: #333333; font-size: 14px; text-transform: capitalize; font-weight: 800; background: #00aeef; padding: 5px 10px; border-radius: 5px;">{{ $user->role ?? null }}</strong>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; border-bottom: 1px solid #f0f0f0;">
                            ...
                            <strong style="color: #333333; font-size: 14px;">{{ $user->first_name }}
