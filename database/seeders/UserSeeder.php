    ...
    public function run(): void
    {
        if (app()->environment('local')) {
            ...
            DB::table('users')->insert([
                ...
                ['id' => 4, 'name' => 'Director', 'username'=>'@derector', 'slug' => 'director', 'email' => 'direcotr@director.com', 'password' => Hash::make('12345678'), 'stripe_account_id' => 'acct_1RHGjbQPESrwz7hv', 'otp_verified_at' => now()],
                ['id' => 5, 'name' => 'Evaluator', 'username'=>'@evaluator', 'slug' => 'evaluator', 'email' => 'artist@artist.com', 'password' => Hash::make('12345678'), 'stripe_account_id' => 'acct_1RHGjbQPESrwz7hv', 'otp_verified_at' => now()],
                ['id' => 6, 'name' => 'Referee', 'username'=>'@referee', 'slug' => 'referee', 'email' => 'referee@referee.com', 'password' => Hash::make('12345678'), 'stripe_account_id' => 'acct_1RHGjbQPESrwz7hv', 'otp_verified_at' => now()]
            ]);
